    ...
    return (
        (<motion.div
            ...
            className={cn(
                ...
                visible ? "text-neutral-300 hover:text-white" : "text-black dark:text-neutral-300 hover:text-neutral-700 dark:hover:text-white",
                className
            )}>
            {items.map((item, idx) => (
                <a
...
export const NavbarLogo = ({ visible }) => {
    return (
        <>
            ...
            <div className={cn("grid flex-1 text-left text-sm leading-tight transition-colors", visible ? "text-white" : "text-black dark:text-white")}>
