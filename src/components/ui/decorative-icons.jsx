...
const DecorativeIcons = ({ isDark = true }) => {
    const icons = [
        ...
        { id: 4, Icon: Palette, x: "14%", y: "50%", delay: 0.9, size: 32, glow: true },
        ...
        { id: 8, Icon: Globe, x: "90%", y: "10%", delay: 0.2, size: 34, glow: true },
        { id: 9, Icon: Cloud, x: "85%", y: "24%", delay: 0.5, size: 28 },
        { id: 10, Icon: Wifi, x: "92%", y: "36%", delay: 0.8, size: 26 },
        { id: 11, Icon: Layers, x: "86%", y: "48%", delay: 1.1, size: 32, glow: true },
                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            ...
                            boxShadow: glow
                                ? `0 0 30px rgba(250, 204, 21, ${isDark ? 0.3 : 0.2}), inset 0 0 20px rgba(250, 204, 21, 0.1)`
                    ...
                    >
                        <Icon
                            ...
                            strokeWidth={1.5}
                            style={{
                                filter: glow ? `drop-shadow(0 0 8px rgba(250, 204, 21, 0.6))` : 'none',
                            }}
                        />
                    </div>
                </motion.div>
